...
// let book1 = {title: 'Math', pageCount: 102, genre: 'scince'};
// let book2 = {title: 'Tarzan', pageCount: 201, genre: 'Пригоди'};
// let book3 = {title: 'Columbo', pageCount: 114, genre: 'Detective'}
...
//     pageCount: 159,
//     genre: "since",
//     authors: ["yeshchcenko", "palkin"]
// }
// let b11 = {
//     title: "Острів скарбів",
//     pageCount: 89,
//     genre: "fantasy",
//     authors: ['Stiveson', 'Defo']
// }
// let с11 = {
//     title: 'Англійська мова',
//     pageCount: 350,
//     genre: "universal guide",
//     authors: ['Мєдвєдєва', "Холден"]
// }
...
//         'вранішня температура,градусів Цельсія': 18,
//         'денна температура,градусів Цельсія': 25,
//         'вечірня температура,градусів Цельсія': 19
//     },
//     {
//         'день тижня': 'вівторок',
//         'вранішня температура,градусів Цельсія': 15,
//         'денна температура,градусів Цельсія': 22,
//         'вечірня температура,градусів Цельсія': 16
//     },
//     {
//         'день тижня': 'середа',
//         'вранішня температура,градусів Цельсія': 11,
//         'денна температура,градусів Цельсія': 20,
//         'вечірня температура,градусів Цельсія': 14
//     },
//     {
//         'день тижня': 'четвер',
//         'вранішня температура,градусів Цельсія': 15,
//         'денна температура,градусів Цельсія': 19,
//         'вечірня температура,градусів Цельсія': 17
//     },
//     {
//         'день тижня': "п'ятниця",
//         'вранішня температура,градусів Цельсія': 18,
//         'денна температура,градусів Цельсія': 23,
//         'вечірня температура,градусів Цельсія': 18
//     },
//     {
//         'день тижня': 'субота',
//         'вранішня температура,градусів Цельсія': 18,
//         'денна температура,градусів Цельсія': 27,
//         'вечірня температура,градусів Цельсія': 22
//     },
//     {
//         'день тижня': 'неділя',
//         'вранішня температура,градусів Цельсія': 21,
//         'денна температура,градусів Цельсія': 28,
//         'вечірня температура,градусів Цельсія': 23
//     }
// ];
...
//     }
// ];
// console.log(temerature1);
//
// let temerature11 = [
//     {
//         "понеділок": [{'вранішня температура,градусів Цельсія': 18},
//             {'денна температура,градусів Цельсія': 25},
//             {'вечірня температура,градусів Цельсія': 19}
//         ]
//     },
//     {
//         "вівторок": [{'вранішня температура,градусів Цельсія': 15},
//             {'денна температура,градусів Цельсія': 22},
//             {'вечірня температура,градусів Цельсія': 16}
//         ]
//     },
//     {
//         "середа": [{'вранішня температура,градусів Цельсія': 11},
//             {'денна температура,градусів Цельсія': 20},
//             {'вечірня температура,градусів Цельсія': 14}
//         ]
//     },
//     {
//         "четвер": [{'вранішня температура,градусів Цельсія': 15},
//             {'денна температура,градусів Цельсія': 19},
//             {'вечірня температура,градусів Цельсія': 17}
//         ]
//     },
